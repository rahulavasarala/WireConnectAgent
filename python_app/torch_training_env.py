...
if __name__ == "__main__":
    ...
    obs = torch.zeros((args.num_steps, args.num_envs,envs.observation_space_dim)).to(device)
    actions = torch.zeros((args.num_steps, args.num_envs, envs.action_space_dim)).to(device)
    ...
    for iteration in range(0, args.num_iterations):
        ...
        # flatten the batch
        b_obs = obs.reshape((-1,envs.observation_space_dim))
        b_logprobs = logprobs.reshape(-1)
        b_actions = actions.reshape((-1,envs.action_space_dim))
